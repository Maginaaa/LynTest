<template lang="html">
  <div :val="value_">
    ...
    <div style="margin-top: 5px">
      ...
      <el-checkbox-group v-model="appoint" style="margin-left: 10px;  line-height: 16px;">
          <el-checkbox @change="type = '4'"  v-for="i in 7" :key="i" :label="i" style="margin-left: -8px"></el-checkbox>
      </el-checkbox-group>
    </div>
  </div>
</template>
    ...
    updateVal() {
      ...
      if (this.value === '?') {
        ...
        if (this.value.split('-').length === 2) {
          ...
          this.cycle = { start: this.value.split('-')[0], end: this.value.split('-')[1] }
        }
        ...
        if (this.value.split('/').length === 2) {
          ...
          this.loop = { start: this.value.split('/')[0], end: this.value.split('/')[1] }
        }
        ...
        if (this.value.split('#').length === 2) {
          ...
          this.week = { start: this.value.split('#')[0], end: this.value.split('#')[1] }
        }
