  ...
  <div :val="value_">
    ...
    <div style="margin-top: 5px">
      ...
      <el-checkbox-group v-model="appoint">
        <div  v-for="i in 6" :key="i" style="line-height: 16px;margin-left: 10px">
          <el-checkbox @change="type = '4'"  v-for="j in 10" :key="j" :label="(i - 1) + '' + (j - 1)" style="margin-left: -8px"></el-checkbox>
        </div>
      </el-checkbox-group>
    </div>
  </div>
