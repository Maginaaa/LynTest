...
var SunburstLayer = /** @class */ (function (_super) {
    ...
    SunburstLayer.prototype.getSunburstData = function (data, level) {
        ...
        sunBurstData.push(__assign(__assign({}, root), { x: [root.x0, root.x1, root.x1, root.x0, root.x1], y: [root.y1, root.y1, root.y0, root.y0, root.y0] }));
    ...
    SunburstLayer.prototype.afterRender = function () {
        if (this.options.label && this.options.label.visible) {
            var label = new SunburstLabel(__assign({ view: this.view, plot: this }, this.options.label));
            label.render();
        }
    ...
    SunburstLayer.prototype.getAllNodes = function (data, nodes, level) {
        ...
        _.each(data, function (d) {
            if (_.hasKey(d, 'x0') && d.depth <= max) {
                nodes.push(__assign(__assign({}, d), { y: [d.x0, d.x1, d.x1, d.x0], x: [d.y1, d.y1, d.y0, d.y0] }));
            }
