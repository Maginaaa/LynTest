...
var WordCloudLayer = /** @class */ (function (_super) {
    ...
    WordCloudLayer.prototype._initToolTips = function () {
        this._toolTips = new word_cloud_tooltips_1.default(tslib_1.__assign(tslib_1.__assign({}, this.options.tooltip), { showTitle: false, visible: true, canvas: this.canvas, follow: true, inPanel: false }));
    };
